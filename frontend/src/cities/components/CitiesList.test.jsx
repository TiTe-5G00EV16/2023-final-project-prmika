...
const TEST_CITIES_DATA = [
    ...
    },
    {
      ...
      "capital": "Luanda",
      "country": "Angola",
      "image": "https://www.norwep.com/events/decarbonisation-and-low-emission-delegation-to-angola/_/attachment/inline/83a994ba-fe2a-4ff1-9b57-fff9bb8ab336:a5111e8b8358dc7066ba1bce9d63c62873075bd9/Luanda3.png"
    }
  ];

describe('The CitiesList', () => {
  test('should show no cities when no city is available', () => {
